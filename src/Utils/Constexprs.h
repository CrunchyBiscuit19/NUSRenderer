...
constexpr u32 INITIAL_MAIN_INSTANCES = INITIAL_MODEL_INSTANCES * 1e2;
constexpr u32 INITIAL_MODEL_MATERIALS = 1e2;
constexpr u32 INITIAL_MAIN_MATERIALS = INITIAL_MODEL_MATERIALS * 1e2;
constexpr u32 INITIAL_MODEL_NODES = 1e4;
constexpr u32 INITIAL_MAIN_NODES = INITIAL_MODEL_NODES * 1e2;
constexpr u32 INITIAL_MODEL_BOUNDS = 1e4;
constexpr u32 INITIAL_MAIN_BOUNDS = INITIAL_MODEL_BOUNDS * 1e2;
constexpr u32 DRAW_MAX_RENDER_ITEMS = 1e5;
constexpr u32 BATCH_MAX_RENDER_ITEMS = 1e5;
constexpr u32 BATCH_MAX_RENDER_INSTANCES = 1e6;
constexpr u32 MAIN_MAX_RENDER_INSTANCES = 1e6;
