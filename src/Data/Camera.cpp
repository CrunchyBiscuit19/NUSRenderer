...
void Camera::initBuffers() {
    ...
    mFrustumBuffer = mRenderer->mResources.createAddressedBuffer(frustumBufferSize, vk::BufferUsageFlagBits::eStorageBuffer | vk::BufferUsageFlagBits::eShaderDeviceAddress, VMA_MEMORY_USAGE_CPU_TO_GPU);
